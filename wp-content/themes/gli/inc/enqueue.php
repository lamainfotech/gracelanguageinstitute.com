...
{
    wp_enqueue_style('gli-slick-css', get_template_directory_uri() . '/vendors/slick/slick.css');
    ...
    wp_enqueue_script('gli-slick-js', get_template_directory_uri() . '/vendors/slick/slick.min.js', '', null, true);
