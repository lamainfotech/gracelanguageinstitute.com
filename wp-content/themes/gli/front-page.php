    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-4 col-md-6 mb-1 mb-sm-2 mb-lg-0">
                <div class="card-icon text-center">
                    <div class="card-icon__top">
                        <i class="icon-online-learning"></i>
                        <h4>Affordable Courses​</h4>
                        <p>Scuola is an online learning and teaching school with over 10000 courses and 1 million students.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 mb-1 mb-sm-2 mb-lg-0">
                <div class="card-icon text-center">
                    <div class="card-icon__top">
                        <i class="icon-work-schedule"></i>
                        <h4>Efficient & Flexible​</h4>
                        <p>Online learning is booming as more universities and businesses recognize the benefits it brings to students.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="slider-col-4 slick-gutter-0 slick-no-dots">
            <div class="item">
                <article class="card-media bg-cover">
                    <img src="/wp-content/uploads/red-shirt-group-people-business-conference-modern-classroom-daytime.jpg" width="1000" height="667" loading="lazy" alt="English Courses">
                    <div class="card-media__body text-center">
                        <h3 class="h4">General English Course</h3>
                    </div>
                </article><!-- /.card-media -->
            </div><!-- /.item -->
            <div class="item">
                <article class="card-media bg-cover">
                    <img src="/wp-content/uploads/confident-teacher-explaining-lesson-pupils.jpg" width="1000" height="667" loading="lazy" alt="Speaking Classes">
                    <div class="card-media__body text-center">
                        <h3 class="h4">Speaking Classes</h3>
                    </div>
                </article><!-- /.card-media -->
            </div><!-- /.item -->
            <div class="item">
                <article class="card-media bg-cover">
                    <img src="/wp-content/uploads/i-m-prepared-exam-very-well.jpg" width="1000" height="667" loading="lazy" alt="IELTS Life Skills">
                    <div class="card-media__body text-center">
                        <h3 class="h4">IELTS Life Skills</h3>
                    </div>
                </article><!-- /.card-media -->
            </div><!-- /.item -->
            <div class="item">
                <article class="card-media bg-cover">
                    <img src="/wp-content/uploads/group-asia-young-creative-people-smart-casual-wear-smiling-arms-crossed-creative-office-workplace.jpg" width="1000" height="667" loading="lazy" alt="Nepali Classes">
                    <div class="card-media__body text-center">
                        <h3 class="h4">Nepali Classes</h3>
                    </div>
                </article><!-- /.card-media -->
            </div><!-- /.item -->
            <div class="item">
...
<section class="form bg-cover py-xxl-6 py-lg-4 py-sm-3 py-2">
    <div class="container">
        ...
        <div class="bg-cover minHeight-420 py-xl-10 py-lg-8 py-sm-6 py-4">
...
<section class="articles bg-lightGreen pt-xxl-5 pb-xxl-6 py-lg-4 py-sm-3 py-2">
    <div class="container">
        <header class="block-title text-center block-width-70 mx-auto mb-lg-3 mb-sm-2 mb-1">
            ...
            <p>Learning a language is a complex, time-intensive task that requires dedication, persistence, and hard work.</p>
        </header>
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-1 mb-sm-2 mb-lg-0">
                <article class="card card-blog card-blog--alt">
                    <picture class="card-blog__media">
                        <source srcset="<?php echo site_url(); ?>/wp-content/uploads/business-women-signature-document.jpg" type="image/jpg">
                        <img src="<?php echo site_url(); ?>/wp-content/uploads/business-women-signature-document.jpg" width="1000" height="667" loading="lazy" alt="Business women signature document">
                    </picture> <!-- /.card-blog__media -->

                    <div class="card-blog__content">
                        <div class="card-blog__head">
                            <span class="card-blog__category">Writing</span>
                        </div>
                        <div class="card-blog__title text-center">
                            <a href="#" class="stretched-link">
                                <h3 class="h5 mb-0">10 Tips to Improve Your Story Writing Skills</h3>
                            </a>
                        </div>
            ...
            <div class="col-md-6 col-lg-4 mb-1 mb-sm-2 mb-lg-0">
                <article class="card card-blog card-blog--alt">
                    <picture class="card-blog__media">
                        <source srcset="<?php echo site_url(); ?>/wp-content/uploads/lovely-asian-young-lady-portriat-happy-woman-lifestyle-concept.jpg" type="image/jpg">
                        <img src="<?php echo site_url(); ?>/wp-content/uploads/lovely-asian-young-lady-portriat-happy-woman-lifestyle-concept.jpg" width="1000" height="667" loading="lazy" alt="lovely asian young lady portriat happy woman lifestyle concept">
                    </picture> <!-- /.card-blog__media -->

                    <div class="card-blog__content">
                        <div class="card-blog__head">
                            <span class="card-blog__category">Reading</span>
                        </div>
                        <div class="card-blog__title text-center">
                            <a href="#" class="stretched-link">
                                <h3 class="h5 mb-0">Super Reading: 7 Proven Strategies to Read Fast</h3>
                            </a>
                        </div>
                    </div> <!-- /.card-blog__content -->
                </article><!-- /.card-blog -->
